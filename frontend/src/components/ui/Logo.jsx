...
export function LogoMark({ className = 'w-5 h-5' }) {
    return (<svg viewBox="0 0 32 32" className={className} fill="none">
...
export function Logo({ className = 'w-9 h-9' }) {
    return (<div className={`${className} rounded-xl bg-gradient-to-br from-brand-500 to-brand-800 flex items-center justify-center shrink-0`}>
