            ...
            <>
              {file ? (
                ...
                <label
                  ...
                  className={`flex flex-col items-center justify-center gap-2 border border-dashed rounded-lg px-4 py-10 cursor-pointer transition-colors ${
              ...
              {file && (
                <div className="flex items-center gap-3">
                  ...
                  <select
                    ...
                    className="bg-gray-800 border border-gray-700 rounded-lg px-3 py-1.5 text-sm text-gray-100 focus:outline-none focus:ring-2 focus:ring-brand-500 disabled:opacity-50"
                  >
