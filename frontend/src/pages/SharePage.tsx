...
import { shareService, type ShareRetrieveResponse } from '../services/shareService'
  ...
  return (
    <div className="surface p-6 flex flex-col gap-4">
      ...
      {result ? (
        ...
        <>
          <Textarea
            placeholder="Paste or type the information you want to share…"
            rows={6}
            value={content}
          ...
          {file ? (
            ...
            <label className="flex items-center gap-2 text-sm text-gray-400 hover:text-gray-200 cursor-pointer w-fit">
...
function ReceiveCard() {
  ...
  const [loading, setLoading] = useState(false)
  const [result, setResult] = useState<ShareRetrieveResponse | null>(null)
      ...
      {result ? (
          ...
          {result.content_type === 'text' ? (
            ...
            <div className="flex items-center gap-3 bg-gray-800 border border-gray-700 rounded-lg px-4 py-3">
              ...
              <a
                ...
                className="p-2 rounded-lg text-gray-400 hover:text-gray-100 hover:bg-gray-700 transition-colors shrink-0"
                title="Download"
              >
        ...
        <>
          <input
            ...
            inputMode="numeric"
            maxLength={6}
            className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-center text-3xl font-mono tracking-[0.3em] text-gray-100 placeholder-gray-700 focus:outline-none focus:ring-2 focus:ring-brand-500"
          />
